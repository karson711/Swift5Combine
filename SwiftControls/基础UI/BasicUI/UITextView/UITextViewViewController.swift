...
class UITextViewViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.title = "UITextView详解"
        self.view.backgroundColor = UIColor.white
        
        let textView = UITextView.init(frame: CGRect.init(x: 20, y: 200, width: UIScreen.main.bounds.size.width-40, height: 300))
        ...
        //设置富文本
        let attributeString:NSMutableAttributedString = NSMutableAttributedString(string: "这是一条测试UITextview的字符串数据，欢迎访问 http://www.baidu.com")
        //设置字体颜色
...
extension UITextViewViewController:UITextViewDelegate{
    ...
    private func textView(_ textView: UITextView, shouldInteractWithURL: URL, in characterRange: NSRange) -> Bool{
        return true
    }
